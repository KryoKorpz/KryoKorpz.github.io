...
export default function ImageGen(props: GenProps) {
  ...
  const onSubmit = async (event: any) => {
    ...
    setImagePath(URL.createObjectURL(await response.blob()));
    manageState();
    return URL.revokeObjectURL(imagePath);
  };
  ...
  return (
    <div>
      ...
      <div>
        {loading && (
          <div role='status' class='w-1/2 flex justify-center'>
            <svg
              aria-hidden='true'
